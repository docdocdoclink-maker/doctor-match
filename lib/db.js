...
// That's a bad time to run schema migrations/seeding — multiple processes
// end up racing on the same file. Skip all of it during that build phase;
// it still runs normally the moment the real server process starts.
