      ...
      <div style={{ fontSize: 14, lineHeight: 1.9, color: "#374151" }}>
        ...
        <Section title="第6条（安全管理措置）">
          <ul style={{ paddingLeft: 20, margin: 0 }}>
            ...
            <li>
              履歴書・医師免許証は、本人及び本人確認を行う運営者のみアクセスできます。チャットのメッセージ内容・添付ファイルは、原則として本人及び取引の相手方のみがアクセスでき、運営者は、医師又は病院いずれかが記録を開示した場合に限りアクセスします（この場合も、運営者はトラブルの仲介・解決を行うものではありません）
            </li>
