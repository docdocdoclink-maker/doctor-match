      ...
      >
        ...
        {isDoctor ? (
          <ul style={{ fontSize: 14, lineHeight: 1.9, paddingLeft: 20, margin: "0 0 16px" }}>
            ...
            <li>
              登録時に入力した<strong>専門医資格は、病院とやり取りを始めると病院側に表示</strong>されます（未入力なら表示されません）。履歴書・医師免許証は本人確認のみに使い、共有をオンにしない限り病院には見えません。
            </li>
            <li>
              求人一覧の<strong>「求職中」トグルがオンの間だけ、病院から新規にメッセージ（お声がけ）を受け取れます</strong>。今は探していない時期はオフにして一時停止できます（オフでも、ご自身から病院へメッセージを送ることは常に可能です）。
            </li>
            <li>
